module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c37 = function(extension, quality, pct) {
                var result = {
        ...
        peg$c53 = { type: "other", description: "Unit abbreviation" },
        peg$c54 = /^[a-z]/i,
        peg$c55 = { type: "class", value: "[a-z]i", description: "[a-z]i" },
        peg$c56 = function(first, second) {
                return first + second;
            },
        peg$c57 = { type: "other", description: "A percentage, like 30%" },
        peg$c58 = function(num) {
                return parseInt(num.join("")) / 100;
            },
        peg$c59 = function(chars) {
                return chars.join("")
            },
        peg$c60 = { type: "other", description: "A good character or a dot" },
        peg$c61 = ".",
        peg$c62 = { type: "literal", value: ".", description: "\".\"" },
        peg$c63 = { type: "other", description: "A sequence of characters that ends with a dot" },
        peg$c64 = function(chars) {
                return chars.concat(".");
            },
        peg$c65 = { type: "other", description: "A sequence of characters, including dots" },
        peg$c66 = function(chars) {
                return chars.join("");
            },
        peg$c67 = { type: "other", description: "A sequence of characters, excluding dots" },
        peg$c68 = { type: "other", description: "A character, including dots" },
        peg$c69 = /^[^,+]/,
        peg$c70 = { type: "class", value: "[^,+]", description: "[^,+]" },
        peg$c71 = { type: "other", description: "A character, excluding dots and other weird things" },
        peg$c72 = /^[^+,."\/*<>?!:|\\\0-\x1F]/,
        peg$c73 = { type: "class", value: "[^+,.\"\\/*<>?!:|\\\\\\0-\\x1F]", description: "[^+,.\"\\/*<>?!:|\\\\\\0-\\x1F]" },
        peg$c74 = { type: "other", description: "A nonnegative number, which may or may not have leading zeros" },
        peg$c75 = function(parts) { return parseFloat(parts); },
        peg$c76 = function(parts) { return parseFloat("0" + parts); },
        peg$c77 = /^[0-9]/,
