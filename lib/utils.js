(function () {
    ...
    function traverseLayers(obj, callback, isLayer) {
        ...
        if (obj.layers) {
            obj.layers.some(function (child) {
                return traverseLayers(child, callback, true);
            });
        }
    }

    function convertToPixels(value, unit, ppi) {
    ...
    exports.traverseLayers          = traverseLayers;
